...
Object.assign(window.scenes, {
    ...
    "s2_wife_settlement": {
        ...
        castAssets: ["Nephi"],
        choices: [
            { text: "Teach the children to pray for the Lamanites and love them.", nextScene: "module_end_story_division", effect: { faith: 2, unity: 1 }, feedback: "Story Complete." },
            { text: "Teach caution and fear of the 'darkened' Lamanites to ensure survival.", nextScene: "module_end_story_division", effect: { worldly: 2, knowledge: 1 }, feedback: "Story Complete." },
            { text: "Work to establish new, unified traditions that bind the Nephite people together.", nextScene: "module_end_story_division", effect: { unity: 3 }, feedback: "Story Complete." }
        ]
    }
});