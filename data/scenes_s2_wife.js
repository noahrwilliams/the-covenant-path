...
Object.assign(window.scenes, {
    "s2_wife_intro": {
        ...
        choices: [
            ...
            { text: "Seek comfort by confiding in your sister (Laman's wife) about the hardships.", nextScene: "s2_wife_children", effect: { unity: 2, faith: -1 }, feedback: "Bonding with the 'enemy'." }
        ]
    },
    "s2_wife_children": {
        ...
        choices: [
            ...
            { text: "Tell them to avoid the topic: 'This is a private matter we don't discuss.'", nextScene: "s2_wife_sariah", effect: { worldly: 1 }, feedback: "Avoidance." }
        ]
    },
    "s2_wife_sariah": {
        ...
        choices: [
            ...
            { text: "Take over all of her administrative duties to let her rest in peace.", nextScene: "s2_wife_sisters", effect: { service: 2, worldly: 1 }, feedback: "Physical care." }
        ]
    },
    "s2_wife_sisters": {
        ...
        choices: [
            ...
            { text: "Validate their grief and anger, agreeing that the journey has been unfair.", nextScene: "s2_wife_lehi", effect: { unity: 2, faith: -2 }, feedback: "Empathy at cost of truth." }
        ]
    },
    "s2_wife_lehi": {
        ...
        choices: [
            ...
            { text: "Focus on the complex, practical details of Lehi's burial and estate.", nextScene: "s2_wife_conflict", effect: { knowledge: 1, worldly: 1 }, feedback: "Duty." }
        ]
    },
    "s2_wife_conflict": {
        ...
        choices: [
            ...
            { text: "Appeal to Laman's wife to intervene on your sister's behalf.", nextScene: "s2_wife_warning", effect: { unity: 2, faith: -1 }, feedback: "Diplomacy." }
        ]
    },
    "s2_wife_warning": {
        ...
        castAssets: ["Nephi"],
        choices: [
            { text: "Immediately begin packing, trusting the Lord's command over your sorrow.", nextScene: "s2_wife_packing", effect: { faith: 2 }, covenantUnlock: "Faith", feedback: "Submission." },
            { text: "Risk warning your sisters, begging them to join you.", nextScene: "s2_wife_packing", effect: { unity: 2, worldly: -1 }, feedback: "Dangerous hope." },
            { text: "Take time to weep and mourn the loss of your sisters before moving.", nextScene: "s2_wife_packing", effect: { unity: 1, faith: -1 }, feedback: "Hesitation." }
        ]
    },
    "s2_wife_packing": {
        ...
        choices: [
            ...
            { text: "Prioritize blankets and small comfort items for the children.", nextScene: "s2_wife_depart", effect: { unity: 2, worldly: 1 }, feedback: "Compassion." }
        ]
    },
    "s2_wife_depart": {
